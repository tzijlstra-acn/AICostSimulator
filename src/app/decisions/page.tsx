    ...
    <div className="space-y-6 max-w-[1000px] mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "var(--lunar-text-secondary)" }}>
            Record, track, and export strategic decisions. Persisted to localStorage. Press D from anywhere to open.
          </p>
        </div>
        <button
      ...
      {decisions.length === 0 && !showForm ? (
        <div className="text-center py-16" style={{ color: "var(--lunar-text-muted)" }}>
          ...
          <div className="text-sm">No decisions logged yet. Click &ldquo;Add Decision&rdquo; to start tracking.</div>
        </div>
      ) : (
        <div className="space-y-3">
          {decisions.map((d) => (
