    ...
    <div className="space-y-6 max-w-[1400px] mx-auto">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "var(--lunar-text-secondary)" }}>
          Target partner map across cloud, telco, SI, ISV, academic, and reseller categories
        </p>
      </div>
      ...
      >
        ...
        <div className="text-xs" style={{ color: "var(--lunar-text-secondary)" }}>
          <strong style={{ color: "var(--lunar-amber)" }}>Disclaimer:</strong> All partner records shown are illustrative target partnerships only. No existing partnership with Kimi/Moonshot AI is implied or represented. Partner names are used for planning purposes only.
        </div>
      </div>
