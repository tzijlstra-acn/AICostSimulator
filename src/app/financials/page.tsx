...
export default function FinancialsPage() {
  ...
  const mixOption = {
    ...
    series: [{
      ...
      label: { color: "var(--lunar-text-secondary)", fontSize: 9 },
    }],
  };
  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--lunar-text-primary)" }}>
            Revenue, Sales Capacity & Investment Model
          </h1>
          <p className="text-sm mt-1" style={{ color: "var(--lunar-text-secondary)" }}>
            All inputs are editable assumptions. No gross margin or profit figures are presented as facts.
      ...
      <div className="lunar-card">
        <h2 className="text-sm font-semibold mb-4" style={{ color: "var(--lunar-text-primary)" }}>
          Cost Assumptions
          <EvidenceBadge type="ASSUMPTION" className="ml-2" reasoning="All cost items are planning assumptions. Gross margin is NOT presented as a fact." />
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {[
